...
class Psychology_Therapist_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'psychology-therapist' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $psychology_therapist_font_awesome_icon_array = psychology_therapist_font_awesome_icon_array();
                    foreach ($psychology_therapist_font_awesome_icon_array as $psychology_therapist_font_awesome_icon) {
                            $icon_class = $this->value() == $psychology_therapist_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($psychology_therapist_font_awesome_icon).'"></i>
                            <span class="psychology-therapist-social-class">'.esc_attr($psychology_therapist_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function psychology_therapist_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'psychology-therapist-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'psychology_therapist_customizer_script' );

if(!function_exists('psychology_therapist_font_awesome_icon_array')){
    function psychology_therapist_font_awesome_icon_array(){
