...
if ( ! class_exists( 'Psychology_Therapist_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Psychology_Therapist_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Psychology_Therapist_WPTT_WebFont_Loader( $url );
