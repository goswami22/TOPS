...
class Psychology_Therapist_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Psychology_Therapist_About_Widget',
			__('VW About us', 'psychology-therapist'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'psychology-therapist' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','psychology-therapist'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','psychology-therapist'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','psychology-therapist'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','psychology-therapist'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','psychology-therapist'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','psychology-therapist'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function psychology_therapist_about_custom_load_widget() {
	register_widget( 'Psychology_Therapist_About_Widget' );
}
add_action( 'widgets_init', 'psychology_therapist_about_custom_load_widget' );