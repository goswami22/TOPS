jQuery(document).ready(function($) {
    'use strict';
    var this_obj = psychology_therapist_plugin_activate_plugin;

    $('#gutenberg_editor .plugin-activation-redirect a').addClass('ive-redirect-to-dashboard');

    $(document).on('click', '.psychology-therapist-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message psychology-therapist-plugin-install');
                button.addClass('button-primary psychology-therapist-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.psychology-therapist-recommended-plugins .psychology-therapist-activation-note').css('display','block');
    ...
    $(document).on('click', '.psychology-therapist-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .psychology-therapist-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .psychology-therapist-recommended-plugins').css('display','none');
    });
