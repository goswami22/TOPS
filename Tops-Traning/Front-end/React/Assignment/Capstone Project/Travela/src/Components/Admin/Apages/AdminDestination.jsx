                ...
                <div className="container">
                                            ...
                                            return (
                                                <tr key={index} className='text-center'>
                                                    ...
                                                    <td >
                                                        ...
                                                        <button onClick={() => handlingData(item)} data-bs-toggle="modal" data-bs-target="#editModal" className='text-uppercase fs-6 btn btn-success mx-2'>edit</button>
...

                    {
                        editModal && (
                                ...
                                <div className="modal-dialog modal-lg">
                                    <div className="modal-content">
                                        ...
                                        <div className="modal-header">
                                            <h5 className="modal-title" id="editModalLabel">Popular Destination</h5>
                                        ...
                                        <form onSubmit={submitData}>
                                            <div className="modal-body">
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <input type="text" name="title" value={editData.title} onChange={changeData} className="form-control" />
                                                </div>
                            ...
                            //                 <h1 className="text-white mb-3">Popular Destination</h1>
