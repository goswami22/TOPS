          ...
          <div className="mt-14 grid md:grid-cols-3 gap-6">
            {PLANS.map((p, i) => (
              <Reveal key={p.name} delay={i * 80}>
                <div
                  className={`rounded-2xl p-8 h-full flex flex-col relative ${p.highlight ? "v-surface" : "v-glass v-glass-hover"
                    }`}
                ...
                >
                  ...
                  <a
                    href="#"
                    className={`mt-8 text-center font-semibold py-3 rounded-xl transition ${p.highlight ? "v-grad-btn text-white" : "v-border hover:border-[color:var(--accent)]"
                      }`}
                  >
                    Start free trial
                  </a>
